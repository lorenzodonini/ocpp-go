...
// The field definition of the Authorize request payload sent by the Charge Point to the CSMS.
...
// This field definition of the Authorize confirmation payload, sent by the Charge Point to the CSMS in response to an AuthorizeRequest.
...
//
// A Charge Point MAY authorize identifier locally without involving the CSMS, as described in Local Authorization List.
//
