...
func (_m *MockServerOpt) Execute(s *ws.ServerImpl) {
	_m.Called(s)
}
...
func (_c *MockServerOpt_Execute_Call) Run(run func(s *ws.ServerImpl)) *MockServerOpt_Execute_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*ws.ServerImpl))
	})
	return _c
}
...
func (_c *MockServerOpt_Execute_Call) RunAndReturn(run func(*ws.ServerImpl)) *MockServerOpt_Execute_Call {
	_c.Run(run)
	return _c
}
