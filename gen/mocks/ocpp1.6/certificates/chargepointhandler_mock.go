...
// OnDeleteCertificate provides a mock function for the type MockCertificatesChargePointHandler
func (_mock *MockCertificatesChargePointHandler) OnDeleteCertificate(request *certificates.DeleteCertificateRequest) (*certificates.DeleteCertificateResponse, error) {
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(*certificates.DeleteCertificateRequest) (*certificates.DeleteCertificateResponse, error)); ok {
		return returnFunc(request)
	}
	if returnFunc, ok := ret.Get(0).(func(*certificates.DeleteCertificateRequest) *certificates.DeleteCertificateResponse); ok {
	...
	if returnFunc, ok := ret.Get(1).(func(*certificates.DeleteCertificateRequest) error); ok {
...
func (_c *MockCertificatesChargePointHandler_OnDeleteCertificate_Call) Run(run func(request *certificates.DeleteCertificateRequest)) *MockCertificatesChargePointHandler_OnDeleteCertificate_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 *certificates.DeleteCertificateRequest
		if args[0] != nil {
			arg0 = args[0].(*certificates.DeleteCertificateRequest)
		}
		run(
			arg0,
		)
...
func (_c *MockCertificatesChargePointHandler_OnDeleteCertificate_Call) RunAndReturn(run func(request *certificates.DeleteCertificateRequest) (*certificates.DeleteCertificateResponse, error)) *MockCertificatesChargePointHandler_OnDeleteCertificate_Call {
	_c.Call.Return(run)
	return _c
}

// OnGetInstalledCertificateIds provides a mock function for the type MockCertificatesChargePointHandler
func (_mock *MockCertificatesChargePointHandler) OnGetInstalledCertificateIds(request *certificates.GetInstalledCertificateIdsRequest) (*certificates.GetInstalledCertificateIdsResponse, error) {
	ret := _mock.Called(request)
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(*certificates.GetInstalledCertificateIdsRequest) (*certificates.GetInstalledCertificateIdsResponse, error)); ok {
		return returnFunc(request)
	}
	if returnFunc, ok := ret.Get(0).(func(*certificates.GetInstalledCertificateIdsRequest) *certificates.GetInstalledCertificateIdsResponse); ok {
		r0 = returnFunc(request)
	} else {
		if ret.Get(0) != nil {
	...
	if returnFunc, ok := ret.Get(1).(func(*certificates.GetInstalledCertificateIdsRequest) error); ok {
		r1 = returnFunc(request)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockCertificatesChargePointHandler_OnGetInstalledCertificateIds_Call) Run(run func(request *certificates.GetInstalledCertificateIdsRequest)) *MockCertificatesChargePointHandler_OnGetInstalledCertificateIds_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 *certificates.GetInstalledCertificateIdsRequest
		if args[0] != nil {
			arg0 = args[0].(*certificates.GetInstalledCertificateIdsRequest)
		}
		run(
			arg0,
		)
...
func (_c *MockCertificatesChargePointHandler_OnGetInstalledCertificateIds_Call) RunAndReturn(run func(request *certificates.GetInstalledCertificateIdsRequest) (*certificates.GetInstalledCertificateIdsResponse, error)) *MockCertificatesChargePointHandler_OnGetInstalledCertificateIds_Call {
	_c.Call.Return(run)
	return _c
}

// OnInstallCertificate provides a mock function for the type MockCertificatesChargePointHandler
func (_mock *MockCertificatesChargePointHandler) OnInstallCertificate(request *certificates.InstallCertificateRequest) (*certificates.InstallCertificateResponse, error) {
	ret := _mock.Called(request)
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(*certificates.InstallCertificateRequest) (*certificates.InstallCertificateResponse, error)); ok {
		return returnFunc(request)
	}
	if returnFunc, ok := ret.Get(0).(func(*certificates.InstallCertificateRequest) *certificates.InstallCertificateResponse); ok {
		r0 = returnFunc(request)
	} else {
		if ret.Get(0) != nil {
	...
	if returnFunc, ok := ret.Get(1).(func(*certificates.InstallCertificateRequest) error); ok {
		r1 = returnFunc(request)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockCertificatesChargePointHandler_OnInstallCertificate_Call) Run(run func(request *certificates.InstallCertificateRequest)) *MockCertificatesChargePointHandler_OnInstallCertificate_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 *certificates.InstallCertificateRequest
		if args[0] != nil {
			arg0 = args[0].(*certificates.InstallCertificateRequest)
		}
		run(
			arg0,
		)
...
func (_c *MockCertificatesChargePointHandler_OnInstallCertificate_Call) RunAndReturn(run func(request *certificates.InstallCertificateRequest) (*certificates.InstallCertificateResponse, error)) *MockCertificatesChargePointHandler_OnInstallCertificate_Call {
	_c.Call.Return(run)
	return _c
}
