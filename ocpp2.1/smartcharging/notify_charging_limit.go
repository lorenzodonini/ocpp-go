...
type ChargingLimit struct {
	ChargingLimitSource types.ChargingLimitSourceType `json:"chargingLimitSource" validate:"required,chargingLimitSource21,max=20"` // Represents the source of the charging limit.
	...
	IsLocalGeneration   *bool                         `json:"isLocalGeneration,omitempty" validate:"omitempty"`                     // Indicates whether the charging limit is due to local generation.
}
