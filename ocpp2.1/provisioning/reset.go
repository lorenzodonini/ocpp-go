...
const (
	...
	ResetImmediateAndResume ResetType = "ImmediateAndResume"
...
func isValidResetType(fl validator.FieldLevel) bool {
	...
	switch status {
	case ResetTypeImmediate, ResetTypeOnIdle, ResetImmediateAndResume:
		return true
	default:
		return false
	}
...
type ResetRequest struct {
	Type   ResetType `json:"type" validate:"resetType21"`
