// The ISO 15118 functional block contains OCPP 2.1 features that allow:
//
...
// Needs to be implemented by Charging stations for handling messages part of the OCPP 2.1 ISO 15118 profile.
