...
func (f SendLocalListFeature) GetConfirmationType() reflect.Type {
...
func init() {
	_ = Validate.RegisterValidation("updateStatus", isValidUpdateStatus)
	_ = Validate.RegisterValidation("updateType", isValidUpdateType)
