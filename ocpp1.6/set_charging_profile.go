...
func (f SetChargingProfileFeature) GetConfirmationType() reflect.Type {
...
func NewSetChargingProfileRequest(connectorId int, chargingProfile *ChargingProfile) *SetChargingProfileRequest {
