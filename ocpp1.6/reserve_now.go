...
func (f ReserveNowFeature) GetConfirmationType() reflect.Type {
...
func NewReserveNowRequest(connectorId int, expiryDate *DateTime, idTag string, reservationId int) *ReserveNowRequest {
...
func init() {
	_ = Validate.RegisterValidation("reservationStatus", isValidReservationStatus)
}
