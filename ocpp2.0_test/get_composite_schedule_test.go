...
func (suite *OcppV2TestSuite) TestGetCompositeScheduleRequestValidation() {
	...
	var requestTable = []GenericTestEntry{
		{ocpp2.GetCompositeScheduleRequest{Duration: 600, EvseID: 1, ChargingRateUnit: types.ChargingRateUnitWatts}, true},
		...
		{ocpp2.GetCompositeScheduleRequest{Duration: 600, EvseID: -1, ChargingRateUnit: types.ChargingRateUnitWatts}, false},
		{ocpp2.GetCompositeScheduleRequest{Duration: -1, EvseID: 1, ChargingRateUnit: types.ChargingRateUnitWatts}, false},
...
func (suite *OcppV2TestSuite) TestGetCompositeScheduleConfirmationValidation() {
	...
	var confirmationTable = []GenericTestEntry{
		...
		{ocpp2.GetCompositeScheduleConfirmation{Status: ocpp2.GetCompositeScheduleStatusAccepted, EvseID: 1, Schedule: &ocpp2.CompositeSchedule{StartDateTime: types.NewDateTime(time.Now()), ChargingSchedule: types.NewChargingSchedule("invalidChargingRateUnit")}}, false},
	}
