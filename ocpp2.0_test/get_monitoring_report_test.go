...
func (suite *OcppV2TestSuite) TestGetMonitoringReportRequestValidation() {
	...
	var requestTable = []GenericTestEntry{
		...
		{ocpp2.GetMonitoringReportRequest{RequestID: newInt(42), ComponentVariable: []types.ComponentVariable{}}, true},
		...
		{ocpp2.GetMonitoringReportRequest{ComponentVariable: []types.ComponentVariable{{Variable: types.Variable{Name: "variable1", Instance: "instance1"}}}}, false},
	}
...
func (suite *OcppV2TestSuite) TestGetMonitoringReportConfirmationValidation() {
	...
	var confirmationTable = []GenericTestEntry{
		{ocpp2.GetMonitoringReportConfirmation{Status: types.GenericDeviceModelStatusAccepted}, true},
